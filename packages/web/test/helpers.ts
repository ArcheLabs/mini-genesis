...
export function manifest(overrides: Partial<DeploymentManifest> = {}): DeploymentManifest {
  return {
    ...
    source: { chainId: "420420417", name: "test", currencySymbol: "DOT", nativeDecimals: 10, evmNativeDecimals: 18, rpcHttpUrls: ["http://localhost"], substrateWsUrls: ["ws://localhost"], substrateGenesisHash: SOURCE_HASH, ss58Prefix: 0, explorerUrl: "", contract: SOURCE_CONTRACT, deploymentBlock: "1", runtimeCodeHash: BLOCK_HASH },
