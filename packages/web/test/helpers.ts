...
export function manifest(overrides: Partial<DeploymentManifest> = {}): DeploymentManifest {
  return {
    ...
    source: { chainId: "420420417", name: "test", currencySymbol: "DOT", nativeDecimals: 10, evmNativeDecimals: 18, rpcHttpUrls: ["http://localhost"], substrateWsUrls: ["ws://localhost"], ss58Prefix: 0, explorerUrl: "", genesisHash: SOURCE_HASH, contract: SOURCE_CONTRACT, deploymentBlock: "1", runtimeCodeHash: BLOCK_HASH },
