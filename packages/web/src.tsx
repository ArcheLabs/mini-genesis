...
function App() {
  ...
  const copySelectedPolkadotAddress = () => { if (session?.kind === "polkadot") void navigator.clipboard?.writeText(session.selectedAccountAddress); };
