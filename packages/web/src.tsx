...
function App() {
  ...
  const [genesisStage, setGenesisStage] = useState<GenesisStageId>("phase2");
  ...
  const genesisStagesPage = <GenesisStages language={language} stage={genesisStage} onPhase2StatusChange={setPhase2HeaderStatus} manifest={manifest} publicClient={publicClient} session={session} provider={provider} walletReady={walletReady} correctChain={correctChain} demoMode={demoMode} onConnect={() => setWalletMenu(true)} onRefresh={() => { void refreshDynamic(); }} />;
