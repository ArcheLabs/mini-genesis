...
function App() {
  ...
  const { account, provider, isConnected, status, correctChain, walletReady, chainId, connect, openAccount, switchToGenesisChain, disconnect } = genesisWallet;
