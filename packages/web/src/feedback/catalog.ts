...
const catalog: Record<FeedbackCode, { zh: FeedbackCopy; en: FeedbackCopy }> = {
  ...
  CLAIM_SERVICE_UNCONFIGURED: { zh: { title: "领取服务未配置", message: "Lucky Credit 领取服务暂未配置，请稍后重试。" }, en: { title: "Claim service unavailable", message: "The Lucky Credit claim service is not configured yet." } },
  INVALID_CLAIM_RESPONSE: { zh: { title: "领取信息无效", message: "后端返回的领取信息无法验证，请稍后重试。" }, en: { title: "Invalid claim response", message: "The claim response could not be verified. Try again shortly." } },
  USERNAME_NOT_FOUND: { zh: { title: "用户名不存在", message: "请检查用户名后重试。" }, en: { title: "Username not found", message: "Check the username and try again." } },
  NO_CLAIMABLE_CREDIT: { zh: { title: "暂无可领取额度", message: "当前没有可领取的 Lucky Credit。" }, en: { title: "No claimable credit", message: "There is no Lucky Credit available to claim right now." } },
  CLAIM_STATUS_TIMEOUT: { zh: { title: "领取确认超时", message: "领取仍可能正在处理中，请稍后查看资产余额。" }, en: { title: "Claim confirmation timed out", message: "The claim may still be processing. Check your assets again shortly." } },
  CLAIM_FAILED: { zh: { title: "领取失败", message: "Lucky Credit 领取没有完成，请稍后重试。" }, en: { title: "Claim failed", message: "The Lucky Credit claim did not complete. Try again shortly." } },
  ...
  ACCOUNT_MAPPING_CONFLICT: { zh: { title: "账户映射冲突", message: "该合约地址已绑定到其他 Polkadot 账户，已停止投入。" }, en: { title: "Account mapping conflict", message: "This contract address is already mapped to another Polkadot account." } },
  ACCOUNT_MAPPING_VERIFICATION_FAILED: { zh: { title: "账户映射未确认", message: "账户设置已完成，但链上复核未通过，未发起投入。" }, en: { title: "Account mapping was not verified", message: "Account setup finished, but the on-chain mapping could not be verified." } },
  ...
  ACCOUNT_ADDRESS_RESOLUTION_FAILED: { zh: { title: "无法解析账户地址", message: "Polkadot runtime 暂时无法返回该账户的合约地址。" }, en: { title: "Account address unavailable", message: "The Polkadot runtime could not resolve this account's contract address." } },
  ACCOUNT_ADDRESS_MAPPING_MISMATCH: { zh: { title: "账户地址校验失败", message: "runtime 返回的账户地址与本地诊断结果不一致，已停止投入。" }, en: { title: "Account address mismatch", message: "The runtime account address did not match the diagnostic mapping." } },
  ...
  NATIVE_FEE_ESTIMATE_UNAVAILABLE: { zh: { title: "无法估算网络费用", message: "暂时无法安全估算 Native 交易费用，未发起签名。" }, en: { title: "Network fee unavailable", message: "The Native transaction fee could not be estimated safely, so no signature was requested." } },
  NATIVE_SIGNER_UNAVAILABLE: { zh: { title: "无法准备 Native 签名", message: "无法连接 Polkadot.js Native signer，请稍后重试。" }, en: { title: "Native signer unavailable", message: "The Polkadot.js Native signer could not be prepared. Try again shortly." } },
  NATIVE_SIGNING_FAILED: { zh: { title: "Native 签名失败", message: "钱包签名请求未完成，请检查钱包扩展后重试。" }, en: { title: "Native signing failed", message: "The wallet signing request did not complete. Check the wallet extension and try again." } },
  NATIVE_SIGNING_REJECTED: { zh: { title: "已取消签名", message: "钱包签名请求已取消。" }, en: { title: "Signing cancelled", message: "The wallet signing request was cancelled." } },
  NATIVE_NETWORK_MISMATCH: { zh: { title: "Native 网络不匹配", message: "连接的 Polkadot 网络与当前 Native 配置不一致。" }, en: { title: "Native network mismatch", message: "The connected Polkadot network does not match the Native configuration." } },
  NATIVE_RUNTIME_INCOMPATIBLE: { zh: { title: "TestNet 暂不兼容", message: "当前 TestNet runtime 暂不支持此标准 Native 交易。" }, en: { title: "TestNet runtime incompatible", message: "This testnet runtime does not currently support the standard Native transaction." } },
  NATIVE_SUBMISSION_FAILED: { zh: { title: "Native 交易提交失败", message: "Native 交易未能提交或确认，请查看 staging diagnostic。" }, en: { title: "Native submission failed", message: "The Native transaction could not be submitted or confirmed. Check the staging diagnostic." } },
