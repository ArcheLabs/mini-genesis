...
export type I7afog7ojfpc6j = Array<{
    "phase": Phase;
    "event": Anonymize<I12hc7fqa1l39c>;
...
export type I12hc7fqa1l39c = AnonymousEnum<{
    "System": Anonymize<Icsmotvlvppnff>;
    "ParachainSystem": Anonymize<Icbsekf57miplo>;
    "Preimage": PreimageEvent;
    "Scheduler": Anonymize<Ibca59ru3dpug6>;
    ...
    "Utility": Anonymize<I4m97vr3s0uurv>;
    "Multisig": Anonymize<I5a64ll73v31nv>;
    "Proxy": Anonymize<Ia7fora63f5bde>;
    ...
    "Whitelist": Anonymize<Iepqbr9nofvfl9>;
    ...
    "Revive": Anonymize<Ibrn6iuit59u7e>;
    "AhOps": Anonymize<I4f830gria90rg>;
}>;
export type Icsmotvlvppnff = AnonymousEnum<{
    /**
     ...
     * An extrinsic failed.
     */
    "ExtrinsicFailed": Anonymize<I7seb7h8uvaln>;
    /**
     ...
     */
    "TaskFailed": Anonymize<Iggenr72oh012>;
    /**
     ...
     */
    "RejectedInvalidAuthorizedUpgrade": Anonymize<I4cijsgi5ugp6u>;
}>;
...
export type I7seb7h8uvaln = {
    "dispatch_error": Anonymize<I2nb5ki21eadb1>;
    "dispatch_info": Anonymize<Ic9s8f85vjtncc>;
};
export type I2nb5ki21eadb1 = AnonymousEnum<{
    "Other": undefined;
...
export type Iggenr72oh012 = {
    "err": Anonymize<I2nb5ki21eadb1>;
};
export type Ibgl04rn6nbfm6 = {
    "code_hash": SizedHex<32>;
    "check_version": boolean;
};
export type I4cijsgi5ugp6u = {
    "code_hash": SizedHex<32>;
    "error": Anonymize<I2nb5ki21eadb1>;
};
...
export type Ibca59ru3dpug6 = AnonymousEnum<{
    /**
     * Scheduled some task.
     */
     ...
     */
    "Dispatched": Anonymize<I600if6l4c2tvp>;
    /**
...
export type I600if6l4c2tvp = {
    "task": Anonymize<I9jd27rnpm8ttv>;
    "id"?: Anonymize<I4s6vifaf8k998>;
    "result": Anonymize<In5c8gee6oqsf>;
};
export type I9jd27rnpm8ttv = FixedSizeArray<2, number>;
export type In5c8gee6oqsf = ResultPayload<undefined, Anonymize<I2nb5ki21eadb1>>;
...
export type I4m97vr3s0uurv = AnonymousEnum<{
    /**
     * Batch of dispatches did not complete fully. Index of first failing dispatch given, as
     * well as the error.
     */
    "BatchInterrupted": Anonymize<I9o68l2dgba6c8>;
    /**
     ...
     */
    "ItemFailed": Anonymize<I7u0tt8fvsstb3>;
    /**
     * A call was dispatched.
     */
    "DispatchedAs": Anonymize<Ig4q8j4fi6s2o>;
    /**
     ...
     */
    "IfElseFallbackCalled": Anonymize<Ie1ukfstaj26th>;
}>;
export type I9o68l2dgba6c8 = {
    "index": number;
    "error": Anonymize<I2nb5ki21eadb1>;
};
export type I7u0tt8fvsstb3 = {
    "error": Anonymize<I2nb5ki21eadb1>;
};
export type Ig4q8j4fi6s2o = {
    "result": Anonymize<In5c8gee6oqsf>;
};
export type Ie1ukfstaj26th = {
    "main_error": Anonymize<I2nb5ki21eadb1>;
};
export type I5a64ll73v31nv = AnonymousEnum<{
    /**
     ...
     */
    "MultisigExecuted": Anonymize<Ifcdkbb0kgs9hc>;
    /**
...
export type Ia7fora63f5bde = AnonymousEnum<{
    /**
     * A proxy was executed correctly, with the given.
     */
    "ProxyExecuted": Anonymize<Ig4q8j4fi6s2o>;
    /**
...
export type Iepqbr9nofvfl9 = AnonymousEnum<{
    "CallWhitelisted": Anonymize<I1adbcfi5uc62r>;
    "WhitelistedCallRemoved": Anonymize<I1adbcfi5uc62r>;
    "WhitelistedCallDispatched": Anonymize<I4ff1eadliao0f>;
}>;
export type I1adbcfi5uc62r = {
    "call_hash": SizedHex<32>;
};
export type I4ff1eadliao0f = {
    "call_hash": SizedHex<32>;
    "result": Anonymize<I78cd4a1ojtkk9>;
};
export type I78cd4a1ojtkk9 = ResultPayload<Anonymize<Ia1u1r3n74r13c>, {
...
export type I18q76v9nfp680 = AnonymousEnum<{
    /**
     ...
     */
    "BountyValueIncreased": Anonymize<I32klqpv3q0cp4>;
}>;
...
export type Ibrn6iuit59u7e = AnonymousEnum<{
    /**
     ...
     */
    "EthExtrinsicRevert": Anonymize<Icrd468c4m0t27>;
}>;
...
export type I7qpv90droestd = AnonymousEnum<{
    ...
    "Revive": Anonymize<I1aht7jrqbr9co>;
}>;
...
export type I1aht7jrqbr9co = AnonymousEnum<{
...
export type I20uk2ucctj4ph = AnonymousEnum<{
    /**
     * Anonymously schedule a task.
     */
    "schedule": Anonymize<Iag2vn61apopbd>;
    /**
     ...
     */
    "schedule_named": Anonymize<I5bqp67j8as78d>;
    /**
     ...
     */
    "schedule_after": Anonymize<Ia6so9eugf7otm>;
    /**
     * Schedule a named task after a delay.
     */
    "schedule_named_after": Anonymize<If49joii1cb3gk>;
    /**
...
export type Iag2vn61apopbd = {
    "when": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
    "call": TxCallData;
};
export type I5bqp67j8as78d = {
    "id": SizedHex<32>;
    "when": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
...
export type Ia6so9eugf7otm = {
    "after": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
    "call": TxCallData;
};
export type If49joii1cb3gk = {
    "id": SizedHex<32>;
    "after": number;
    "maybe_periodic"?: Anonymize<Iep7au1720bm0e>;
    "priority": number;
...
export type I35ona7ai9bja6 = AnonymousEnum<{
    /**
     ...
     */
    "as_multi_threshold_1": Anonymize<Ib2marpvcc8fpc>;
    /**
     ...
     */
    "as_multi": Anonymize<I5vio3e8k2b1>;
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
     * approved by a total of `threshold - 1` of `other_signatories`.
     *
...
export type Ib2marpvcc8fpc = {
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
    "call": TxCallData;
};
export type I5vio3e8k2b1 = {
    "threshold": number;
    "other_signatories": Anonymize<Ia2lhg7l2hilo3>;
...
export type I4vbp242ih0d70 = AnonymousEnum<{
    /**
     ...
     */
    "proxy": Anonymize<I4j6p3vmo1t9s0>;
    /**
     ...
     * - `call`: The call to be made by the `real` account.
     */
    "proxy_announced": Anonymize<Iesv6nb40fetts>;
    /**
...
export type I4s1hf5j88tjh8 = AnonymousEnum<{
...
export type I28m52rbmk065o = AnonymousEnum<{
    /**
     ...
     */
    "increase_value": Anonymize<I8g22bn83j942k>;
}>;
...
export type Ibjpqbom0fhdnv = AnonymousEnum<{
    /**
     ...
     */
    "eth_substrate_call": Anonymize<I7q60gptcmnusi>;
    /**
...
export type I2nhpa757v7jk9 = AnonymousEnum<{
    ...
    "Scheduler": Anonymize<I20uk2ucctj4ph>;
    ...
    "Multisig": Anonymize<I35ona7ai9bja6>;
    "Proxy": Anonymize<I4vbp242ih0d70>;
    ...
    "Whitelist": Anonymize<I4s1hf5j88tjh8>;
    ...
    "Revive": Anonymize<Ibjpqbom0fhdnv>;
...
export type Ict3h211klpvhs = ResultPayload<Anonymize<In5c8gee6oqsf>, Anonymize<I5nrjkj9qumobs>>;
...
export type I9ftqq9hg5gcek = ResultPayload<{
...
export type Idogu0mcm64ssm = {
    ...
    "gas_consumed": bigint;
    "result": ResultPayload<Anonymize<I620n7irgfspm4>, Anonymize<I2nb5ki21eadb1>>;
};
...
export type I9mq0s1ommikm5 = {
    ...
    "perform_balance_checks"?: (boolean) | undefined;
...
export type Id22r0gklsr0ok = (Array<[SizedHex<20>, {
    ...
    "storage"?: (Enum<{
        "State": Array<FixedSizeArray<2, SizedHex<32>>>;
        "StateDiff": Array<FixedSizeArray<2, SizedHex<32>>>;
    }>) | undefined;
...
export type I8i7cn80akt4h6 = ResultPayload<Anonymize<Iabpgqcjikia83>, Enum<{
    ...
    "StorageWriteFailed": Anonymize<I2nb5ki21eadb1>;
}>>;
