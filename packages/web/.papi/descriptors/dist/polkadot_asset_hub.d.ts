...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I7afog7ojfpc6j>, false, never>;
        /**
...
type ICalls = {
    ...
    Scheduler: {
         ...
         */
        schedule: TxDescriptor<Anonymize<Iag2vn61apopbd>>;
        /**
         ...
         */
        schedule_named: TxDescriptor<Anonymize<I5bqp67j8as78d>>;
        /**
         ...
         */
        schedule_after: TxDescriptor<Anonymize<Ia6so9eugf7otm>>;
        /**
         * Schedule a named task after a delay.
         */
        schedule_named_after: TxDescriptor<Anonymize<If49joii1cb3gk>>;
        /**
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<Idrv9sn94spntn>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I66celthih5oio>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Idrv9sn94spntn>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I6h467t3h9mu0r>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Idrv9sn94spntn>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Iaoqe81db6mqng>>;
        /**
         ...
         * or both.
         */
        if_else: TxDescriptor<Anonymize<Ie9o86shcq0ome>>;
        /**
         * Dispatches a function call with a provided origin.
         *
         ...
         * The dispatch origin for this call must be _Root_.
         */
        dispatch_as_fallible: TxDescriptor<Anonymize<I6h467t3h9mu0r>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Ib2marpvcc8fpc>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I5vio3e8k2b1>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I4j6p3vmo1t9s0>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Iesv6nb40fetts>>;
        /**
    ...
    Whitelist: {
         ...
         */
        dispatch_whitelisted_call_with_preimage: TxDescriptor<Anonymize<I2ntlmm4bbil8d>>;
    };
    Bounties: {
        /**
    ...
    MultiAssetBounties: {
         ...
         */
        increase_value: TxDescriptor<Anonymize<I8g22bn83j942k>>;
    };
    StateTrieMigration: {
        /**
    ...
    Revive: {
         ...
         */
        eth_substrate_call: TxDescriptor<Anonymize<I7q60gptcmnusi>>;
        /**
         ...
         */
        dispatch_as_fallback_account: TxDescriptor<Anonymize<I2ntlmm4bbil8d>>;
    };
    AhOps: {
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I7seb7h8uvaln>>;
        /**
         ...
         */
        TaskFailed: PlainDescriptor<Anonymize<Iggenr72oh012>>;
        /**
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<I4cijsgi5ugp6u>>;
    };
    ParachainSystem: {
        /**
    ...
    Scheduler: {
         ...
         */
        Dispatched: PlainDescriptor<Anonymize<I600if6l4c2tvp>>;
        /**
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I9o68l2dgba6c8>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I7u0tt8fvsstb3>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<Ig4q8j4fi6s2o>>;
        /**
         ...
         */
        IfElseFallbackCalled: PlainDescriptor<Anonymize<Ie1ukfstaj26th>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Ifcdkbb0kgs9hc>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<Ig4q8j4fi6s2o>>;
        /**
    ...
    Whitelist: {
         ...
         */
        WhitelistedCallDispatched: PlainDescriptor<Anonymize<I4ff1eadliao0f>>;
    };
    Bounties: {
        /**
         * New bounty proposal.
    ...
    MultiAssetBounties: {
         ...
         */
        BountyValueIncreased: PlainDescriptor<Anonymize<I32klqpv3q0cp4>>;
    };
    StateTrieMigration: {
        /**
    ...
    Revive: {
         ...
         */
        EthExtrinsicRevert: PlainDescriptor<Anonymize<Icrd468c4m0t27>>;
    };
    AhOps: {
        /**
...
type IViewFns = {
    ...
    Proxy: {
         ...
         */
        check_permissions: RuntimeDescriptor<[call: Anonymize<I2nhpa757v7jk9>, proxy_type: Anonymize<Idugco9k7jdh0f>], boolean>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Uint8Array], Anonymize<Ict3h211klpvhs>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I2nhpa757v7jk9>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I2nhpa757v7jk9>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I7qpv90droestd>, call: Anonymize<I2nhpa757v7jk9>, result_xcms_version: number], Anonymize<Ibnsp8n876tnd7>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I9ftqq9hg5gcek>>;
    };
    /**
    ...
    ReviveApi: {
         ...
         */
        call: RuntimeDescriptor<[origin: SS58String, dest: SizedHex<20>, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, input_data: Uint8Array], Anonymize<Idogu0mcm64ssm>>;
        /**
         * Instantiate a new contract.
         *
         * See `[crate::Pallet::bare_instantiate]`.
         */
        instantiate: RuntimeDescriptor<[origin: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, code: Anonymize<I9sijb8gfrns29>, data: Uint8Array, salt: Anonymize<I4s6vifaf8k998>], Anonymize<Iaorknft5vtg7f>>;
        /**
         ...
         */
        upload_code: RuntimeDescriptor<[origin: SS58String, code: Uint8Array, storage_deposit_limit: Anonymize<I35p85j063s0il>], Anonymize<Ibitbjt0urruo8>>;
        /**
         ...
         */
        get_storage: RuntimeDescriptor<[address: SizedHex<20>, key: SizedHex<32>], Anonymize<I8i7cn80akt4h6>>;
        /**
         ...
         * doesn't exist, or doesn't have a contract then `Err` is returned.
         */
        get_storage_var_key: RuntimeDescriptor<[address: SizedHex<20>, key: Uint8Array], Anonymize<I8i7cn80akt4h6>>;
        /**
...
export type Polkadot_asset_hubDispatchError = Anonymize<I2nb5ki21eadb1>;
type IAsset = PlainDescriptor<Anonymize<If9iqq7i64mur8>>;
export type Polkadot_asset_hubExtensions = {};
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Polkadot_asset_hub = {
    descriptors: {
    ...
    asset: IAsset;
    extensions: Polkadot_asset_hubExtensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: Polkadot_asset_hub;
...
export type Polkadot_asset_hubCallData = Anonymize<I2nhpa757v7jk9> & {
    value: {
        type: string;
    };
};
type AllInteractions = {
    ...
    tx: {
        ...
        MultiAssetBounties: ['fund_bounty', 'fund_child_bounty', 'propose_curator', 'accept_curator', 'unassign_curator', 'award_bounty', 'close_bounty', 'check_status', 'retry_payment', 'increase_value'];
    ...
    events: {
        ...
        MultiAssetBounties: ['BountyCreated', 'ChildBountyCreated', 'BountyBecameActive', 'BountyAwarded', 'BountyPayoutProcessed', 'BountyFundingProcessed', 'BountyRefundProcessed', 'BountyCanceled', 'CuratorUnassigned', 'CuratorProposed', 'PaymentFailed', 'Paid', 'BountyValueIncreased'];
...
export type Polkadot_asset_hubWhitelistEntry = PalletKey | `query.${NestedKey<AllInteractions['storage']>}` | `tx.${NestedKey<AllInteractions['tx']>}` | `event.${NestedKey<AllInteractions['events']>}` | `error.${NestedKey<AllInteractions['errors']>}` | `const.${NestedKey<AllInteractions['constants']>}` | `view.${NestedKey<AllInteractions['viewFns']>}` | `api.${NestedKey<AllInteractions['apis']>}`;
type PalletKey = `*.${({
